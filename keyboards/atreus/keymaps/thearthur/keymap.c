...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT( /* Qwerty */
    ...
    KC_ESC, KC_TAB, KC_LGUI,  KC_LSFT, RGUI_T(KC_BSPC),  KC_LCTL, KC_LALT, RSFT(KC_SPC),  MO(_RS), KC_MINS, KC_QUOT, KC_ENT
  ),
  ...
  [_LW] = LAYOUT( /* [> LOWER <] */
    ...
    KC_NO,   KC_VOLU, KC_NO,   KC_NO,   QK_REBOOT/*RESET*/,                     KC_NO,   KC_F1,   KC_F2,   KC_F3,   KC_F12  ,
