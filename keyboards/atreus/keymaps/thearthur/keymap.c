...
enum {
 ...
 tap_dance_action_t tap_dance_actions[] = {
       [TD_ALT_TAB] = ACTION_TAP_DANCE_DOUBLE(KC_LALT, KC_TAB),
 };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QW] = LAYOUT( /* Qwerty */
    ...
    KC_ESC, KC_TAB, KC_LGUI,  KC_LSFT, RGUI_T(KC_BSPC),  LCTL_T(KC_TAB), LALT_T(KC_TAB), RSFT(KC_SPC),  MO(_RS), KC_MINS, KC_QUOT, KC_ENT
  ),
